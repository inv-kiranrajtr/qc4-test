...
namespace ExcelAddIn.Common
{
    public static class ExcelUtil
    {
        ...
        public static Worksheet setLoading()
        {
        ...
        {
            Workbook exBook = Globals.ThisAddIn.Application.ActiveWorkbook;
        ...
        public static string GetActiveWorkBookName()
        {
            ...
            try
            {
                WorkbookName = Globals.ThisAddIn.Application.ActiveWorkbook.FullName;
            }
            catch (Exception ex)
            {
        ...
        public static void ResetCell(Excel.Range excelCell, bool resetcolor = true, bool resetvalidation = true)
        {
			...
			if (resetcolor)
            {
                ExcelUtil.SetCellInteriorColor(excelCell, Excel.XlColorIndex.xlColorIndexNone);
            }
            if (resetvalidation)
            {
        ...
        public static Excel.Range GetNamedRange(string CodeName, string RangeName)
        {
            try
            {
                Excel.Range ReturnRange = GetWorksheetByName(CodeName).get_Range(RangeName);
		...
		public static Excel.Worksheet GetWorksheetByCodeName(string SheetName)
        {
            try
            {
		...
		public static Excel.Worksheet GetWorkSheetByCodeName(string codeName)
		{
        ...
        public static Excel.Worksheet GetWorksheetByName(string SheetName,Excel.Application application = null)
        {
            if (application == null)
            {
                try
        ...
        public static Excel.Worksheet GetWorksheetByIndex(int SheetIndex)

        {
            try
            {
                return Globals.ThisAddIn.Application.ActiveWorkbook.Worksheets[SheetIndex];
            }
            catch (Exception ex)
            {
                Console.WriteLine(ex.Message);
        ...
        public static Office.CommandBar GetCellContextMenu(string index = "Cell")
        {
            Application targetApp = Globals.ThisAddIn.Application;
            return targetApp.CommandBars[index];
        }

		public static Office.CommandBars GetContextMenus()
		{
			Application targetApp = Globals.ThisAddIn.Application;
			return targetApp.CommandBars;
		}

		public static Office.CommandBarButton GetNewMenuItem(string Caption, int index = 1,string menuIndex = "Cell")
        {
            Office.CommandBar contextMenu = GetCellContextMenu(menuIndex);
		...
		public static void ResetCellMenu(string index = "Cell")
		{
			GetCellContextMenu(index).Reset(); // reset the cell context menu back to the default
		}
