...
namespace ExcelAddIn.Common
{
    internal class AppHelper
    {
        ...
        internal void ExcelSet(bool CancelKeyMode = true, bool screenUpdateMode = true, bool enableEventsMode = true,
                bool calculationMode = true, Application targetApp = null)
        {
            if (null == targetApp)
            {
                targetApp = Globals.ThisAddIn.Application;
            }
        ...
        internal void ExcelReset(bool preMode = false, Application targetApp = null)
        {
            if (null == targetApp)
            {
                targetApp = Globals.ThisAddIn.Application;
