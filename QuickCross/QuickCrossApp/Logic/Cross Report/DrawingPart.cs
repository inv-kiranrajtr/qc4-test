...
namespace Qc4Launcher.Logic.Cross_Report
{
    public class DrawingPart
    {
        ...
        // Top landscape bar cluster + line chart (GWS-compatible sample template + actual report data).
        public static void GenerateColumClusterAndLineGraph(WorksheetPart worksheetPart, CrossTable tmpTable, string sheetName, string lineColour, List<int> LinesIndexList, ref Array v,bool HasLines,
                                             ChartPart chartPart, int firstRow, int lastRow, int firstCol, int lastCol, bool isN, string tempTable,int i, int[] MaxAxesCountArray)
        {
            GwsComboChartBuilder.BuildLandscapeFromReportData(
                worksheetPart, chartPart, LinesIndexList, ref v, HasLines,
        ...
        /// <summary>
        /// GWS-compatible combo chart: clustered COLUMN (全体) + LINE series sharing the same axes.
        /// Uses the working sample template with actual portrait report data.
        /// </summary>
        ...
        {
            GwsComboChartBuilder.BuildPortraitFromReportData(
                worksheetPart, chartPart, firstRow, lastRow, firstCol, tempTable, HasLines, LinesIndexList);
        }
