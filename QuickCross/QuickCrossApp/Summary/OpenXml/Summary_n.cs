...
namespace Qc4Launcher.Summary.OpenXml
{
    public class Summary_n
    {
        ...
        public static void GenerateWorksheetDoubleStandard(WorksheetPart worksheetPart)
        {
            ...
            Column column3 = new Column() { Min = (UInt32Value)4U, Max = (UInt32Value)4U, Width = 40.625D, CustomWidth = true };
            Column column4 = new Column() { Min = (UInt32Value)5U, Max = (UInt32Value)6U, Width = 9.125D, CustomWidth = true };
        ...
        // Generates content of WorksheetTripleStandard.
        ...
        private static void GenerateWorkbookStylesPart(WorkbookStylesPart workbookStylesPart1)
        {
            ...
            CellFormat cellFormat10 = new CellFormat() { NumberFormatId = (UInt32Value)1U, FontId = (UInt32Value)0U, FillId = (UInt32Value)2U, BorderId = (UInt32Value)52U, FormatId = (UInt32Value)0U, ApplyNumberFormat = true, ApplyFill = true, ApplyBorder = true };
            ...
            CellFormat cellFormat25 = new CellFormat() { NumberFormatId = (UInt32Value)165U, FontId = (UInt32Value)0U, FillId = (UInt32Value)2U, BorderId = (UInt32Value)4U, FormatId = (UInt32Value)0U, ApplyNumberFormat = true, ApplyFill = true, ApplyBorder = true };
            ...
            CellFormat cellFormat97 = new CellFormat() { NumberFormatId = (UInt32Value)1U, FontId = (UInt32Value)0U, FillId = (UInt32Value)7U, BorderId = (UInt32Value)52U, FormatId = (UInt32Value)0U, ApplyNumberFormat = true, ApplyFill = true, ApplyBorder = true };
            ...
            CellFormat cellFormat131 = new CellFormat() { NumberFormatId = (UInt32Value)165U, FontId = (UInt32Value)0U, FillId = (UInt32Value)7U, BorderId = (UInt32Value)3U, FormatId = (UInt32Value)0U, ApplyNumberFormat = true, ApplyFill = true, ApplyBorder = true };
            ...
            CellFormat cellFormat210 = new CellFormat() { NumberFormatId = (UInt32Value)165U, FontId = (UInt32Value)0U, FillId = (UInt32Value)2U, BorderId = (UInt32Value)17U, FormatId = (UInt32Value)0U, ApplyNumberFormat = true, ApplyFill = true, ApplyBorder = true };
            Alignment alignment210 = new Alignment() { Vertical = VerticalAlignmentValues.Center };

            cellFormat210.Append(alignment210);

            CellFormat cellFormat211 = new CellFormat() { NumberFormatId = (UInt32Value)165U, FontId = (UInt32Value)0U, FillId = (UInt32Value)2U, BorderId = (UInt32Value)7U, FormatId = (UInt32Value)0U, ApplyNumberFormat = true, ApplyFill = true, ApplyBorder = true };
            Alignment alignment211 = new Alignment() { Vertical = VerticalAlignmentValues.Center };

            cellFormat211.Append(alignment211);

            CellFormat cellFormat212 = new CellFormat() { NumberFormatId = (UInt32Value)165U, FontId = (UInt32Value)1U, FillId = (UInt32Value)0U, BorderId = (UInt32Value)53U, FormatId = (UInt32Value)1U, ApplyBorder = true };
            Alignment alignment212 = new Alignment() { Vertical = VerticalAlignmentValues.Center };

            cellFormat212.Append(alignment212);

            CellFormat cellFormat213 = new CellFormat() { NumberFormatId = (UInt32Value)165U, FontId = (UInt32Value)1U, FillId = (UInt32Value)0U, BorderId = (UInt32Value)54U, FormatId = (UInt32Value)1U, ApplyBorder = true, ApplyAlignment = true };
            ...
            CellFormat cellFormat214 = new CellFormat() { NumberFormatId = (UInt32Value)165U, FontId = (UInt32Value)1U, FillId = (UInt32Value)0U, BorderId = (UInt32Value)55U, FormatId = (UInt32Value)1U, ApplyBorder = true, ApplyAlignment = true };
