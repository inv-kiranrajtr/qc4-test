...
namespace Qc4Launcher.Summary.OpenXml
{
    public class Summary_ps
    {
        ...
        // Generates content of DoubleStandard.
        public static void GenerateWorksheetDoubleStandard(WorksheetPart worksheetPart)
        {
            ...
            worksheet1.Append(phoneticProperties7);
        ...
        private static void GenerateWorkbookStylesPart(WorkbookStylesPart workbookStylesPart1)
        {
            ...
            CellFormat cellFormat3 = new CellFormat() { NumberFormatId = (UInt32Value)49U, FontId = (UInt32Value)5U, FillId = (UInt32Value)0U, BorderId = (UInt32Value)0U, ApplyNumberFormat = false, ApplyFill = false, ApplyBorder = false, ApplyAlignment = false, ApplyProtection = false };
            ...
            CellFormats cellFormats1 = new CellFormats() { Count = (UInt32Value)219U };
            ...
            CellFormat cellFormat12 = new CellFormat() { NumberFormatId = (UInt32Value)164U, FontId = (UInt32Value)0U, FillId = (UInt32Value)4U, BorderId = (UInt32Value)52U, FormatId = (UInt32Value)0U, ApplyNumberFormat = true, ApplyFill = true, ApplyBorder = true };
            ...
            CellFormat cellFormat34 = new CellFormat() { NumberFormatId = (UInt32Value)0U, FontId = (UInt32Value)2U, FillId = (UInt32Value)0U, BorderId = (UInt32Value)3U, FormatId = (UInt32Value)0U, ApplyFont = true, ApplyBorder = true, ApplyAlignment = true };
            ...
            CellFormat cellFormat38 = new CellFormat() { NumberFormatId = (UInt32Value)0U, FontId = (UInt32Value)0U, FillId = (UInt32Value)2U, BorderId = (UInt32Value)6U, FormatId = (UInt32Value)0U, ApplyFill = true, ApplyBorder = true, ApplyAlignment = true };
            ...
            CellFormat cellFormat44 = new CellFormat() { NumberFormatId = (UInt32Value)165U, FontId = (UInt32Value)0U, FillId = (UInt32Value)2U, BorderId = (UInt32Value)7U, FormatId = (UInt32Value)0U, ApplyNumberFormat = true, ApplyFill = true, ApplyBorder = true, ApplyAlignment = true };
            ...
            CellFormat cellFormat57 = new CellFormat() { NumberFormatId = (UInt32Value)167U, FontId = (UInt32Value)0U, FillId = (UInt32Value)2U, BorderId = (UInt32Value)19U, FormatId = (UInt32Value)0U, ApplyFill = true, ApplyBorder = true, ApplyAlignment = true };
            Alignment alignment57 = new Alignment() { Vertical = VerticalAlignmentValues.Center };

            cellFormat57.Append(alignment57);

            CellFormat cellFormat58 = new CellFormat() { NumberFormatId = (UInt32Value)167U, FontId = (UInt32Value)0U, FillId = (UInt32Value)2U, BorderId = (UInt32Value)15U, FormatId = (UInt32Value)0U, ApplyFill = true, ApplyBorder = true, ApplyAlignment = true };
            ...
            Alignment alignment76 = new Alignment() { Horizontal = HorizontalAlignmentValues.Right, WrapText = false };
            ...
            CellFormat cellFormat95 = new CellFormat() { NumberFormatId = (UInt32Value)164U, FontId = (UInt32Value)0U, FillId = (UInt32Value)7U, BorderId = (UInt32Value)2U, FormatId = (UInt32Value)0U, ApplyNumberFormat = true, ApplyFill = true, ApplyBorder = true };
            Alignment alignment95 = new Alignment() { Vertical = VerticalAlignmentValues.Center };

            cellFormat95.Append(alignment95);

            CellFormat cellFormat96 = new CellFormat() { NumberFormatId = (UInt32Value)1U, FontId = (UInt32Value)0U, FillId = (UInt32Value)7U, BorderId = (UInt32Value)4U, FormatId = (UInt32Value)0U, ApplyNumberFormat = true, ApplyFill = true, ApplyBorder = true };
            ...
            CellFormat cellFormat113 = new CellFormat() { NumberFormatId = (UInt32Value)164U, FontId = (UInt32Value)0U, FillId = (UInt32Value)7U, BorderId = (UInt32Value)52U, FormatId = (UInt32Value)0U, ApplyNumberFormat = true, ApplyFill = true, ApplyBorder = true };
            ...
            CellFormat cellFormat132 = new CellFormat() { NumberFormatId = (UInt32Value)165U, FontId = (UInt32Value)0U, FillId = (UInt32Value)7U, BorderId = (UInt32Value)51U, FormatId = (UInt32Value)0U, ApplyNumberFormat = true, ApplyFill = true, ApplyBorder = true };
            ...
            Alignment alignment140 = new Alignment() { Horizontal = HorizontalAlignmentValues.Center, Vertical = VerticalAlignmentValues.Center,WrapText=true };
            ...
            CellFormat cellFormat173 = new CellFormat() { NumberFormatId = (UInt32Value)167U, FontId = (UInt32Value)0U, FillId = (UInt32Value)2U, BorderId = (UInt32Value)3U, FormatId = (UInt32Value)0U, ApplyFill = true, ApplyBorder = true, ApplyAlignment = true };
            ...
            CellFormat cellFormat198 = new CellFormat() { NumberFormatId = (UInt32Value)167U, FontId = (UInt32Value)0U, FillId = (UInt32Value)0U, BorderId = (UInt32Value)52U, FormatId = (UInt32Value)0U, ApplyBorder = true, ApplyAlignment = true };
            ...
            //row
            CellFormat cellFormat209 = new CellFormat() { NumberFormatId = (UInt32Value)165U, FontId = (UInt32Value)0U, FillId = (UInt32Value)2U, BorderId = (UInt32Value)51U, FormatId = (UInt32Value)0U, ApplyNumberFormat = true, ApplyFill = true, ApplyBorder = true };
            Alignment alignment209 = new Alignment() { Vertical = VerticalAlignmentValues.Center };

            cellFormat209.Append(alignment209);

            CellFormat cellFormat210 = new CellFormat() { NumberFormatId = (UInt32Value)165U, FontId = (UInt32Value)0U, FillId = (UInt32Value)2U, BorderId = (UInt32Value)10U, FormatId = (UInt32Value)0U, ApplyNumberFormat = true, ApplyFill = true, ApplyBorder = true };
            Alignment alignment210 = new Alignment() { Vertical = VerticalAlignmentValues.Center };

            cellFormat210.Append(alignment210);

            CellFormat cellFormat211 = new CellFormat() { NumberFormatId = (UInt32Value)165U, FontId = (UInt32Value)0U, FillId = (UInt32Value)2U, BorderId = (UInt32Value)12U, FormatId = (UInt32Value)0U, ApplyNumberFormat = true, ApplyFill = true, ApplyBorder = true };
            Alignment alignment211 = new Alignment() { Vertical = VerticalAlignmentValues.Center };

            cellFormat211.Append(alignment211);

            CellFormat cellFormat212 = new CellFormat() { NumberFormatId = (UInt32Value)165U, FontId = (UInt32Value)0U, FillId = (UInt32Value)2U, BorderId = (UInt32Value)51U, FormatId = (UInt32Value)0U, ApplyNumberFormat = true, ApplyFill = true, ApplyBorder = true };
            Alignment alignment212 = new Alignment() { Vertical = VerticalAlignmentValues.Center };

            cellFormat212.Append(alignment212);

            CellFormat cellFormat213 = new CellFormat() { NumberFormatId = (UInt32Value)165U, FontId = (UInt32Value)0U, FillId = (UInt32Value)2U, BorderId = (UInt32Value)10U, FormatId = (UInt32Value)0U, ApplyNumberFormat = true, ApplyFill = true, ApplyBorder = true };
            Alignment alignment213 = new Alignment() { Vertical = VerticalAlignmentValues.Center };

            cellFormat213.Append(alignment213);

            CellFormat cellFormat214 = new CellFormat() { NumberFormatId = (UInt32Value)165U, FontId = (UInt32Value)0U, FillId = (UInt32Value)2U, BorderId = (UInt32Value)12U, FormatId = (UInt32Value)0U, ApplyNumberFormat = true, ApplyFill = true, ApplyBorder = true };
            Alignment alignment214 = new Alignment() { Vertical = VerticalAlignmentValues.Center };

            cellFormat214.Append(alignment214);

            CellFormat cellFormat215 = new CellFormat() { NumberFormatId = (UInt32Value)49U, FontId = (UInt32Value)1U, FillId = (UInt32Value)0U, BorderId = (UInt32Value)53U, FormatId = (UInt32Value)1U, ApplyBorder = true };
            Alignment alignment215 = new Alignment() { Vertical = VerticalAlignmentValues.Center };

            cellFormat215.Append(alignment215);

            CellFormat cellFormat216 = new CellFormat() { NumberFormatId = (UInt32Value)49U, FontId = (UInt32Value)1U, FillId = (UInt32Value)0U, BorderId = (UInt32Value)54U, FormatId = (UInt32Value)1U, ApplyBorder = true, ApplyAlignment = true };
            Alignment alignment216 = new Alignment() { Horizontal = HorizontalAlignmentValues.Left, Vertical = VerticalAlignmentValues.Center, WrapText = true };

            cellFormat216.Append(alignment216);

            CellFormat cellFormat217 = new CellFormat() { NumberFormatId = (UInt32Value)49U, FontId = (UInt32Value)1U, FillId = (UInt32Value)0U, BorderId = (UInt32Value)55U, FormatId = (UInt32Value)1U, ApplyBorder = true, ApplyAlignment = true };
            ...
            CellFormat cellFormat218 = new CellFormat() { NumberFormatId = (UInt32Value)49U, FontId = (UInt32Value)5U, FillId = (UInt32Value)0U, BorderId = (UInt32Value)56U, FormatId = (UInt32Value)2U, ApplyBorder = true, ApplyAlignment = true };
            ...
            CellFormat cellFormat219 = new CellFormat() { NumberFormatId = (UInt32Value)49U, FontId = (UInt32Value)1U, FillId = (UInt32Value)0U, BorderId = (UInt32Value)59U, FormatId = (UInt32Value)1U, ApplyBorder = true };
            Alignment alignment219 = new Alignment() { Vertical = VerticalAlignmentValues.Center };

            cellFormat219.Append(alignment219);

            CellFormat cellFormat220 = new CellFormat() { NumberFormatId = (UInt32Value)49U, FontId = (UInt32Value)1U, FillId = (UInt32Value)0U, BorderId = (UInt32Value)58U, FormatId = (UInt32Value)1U, ApplyBorder = true, ApplyAlignment = true };
            Alignment alignment220 = new Alignment() { Horizontal = HorizontalAlignmentValues.Left, Vertical = VerticalAlignmentValues.Center, WrapText = true };

            cellFormat220.Append(alignment220);

            CellFormat cellFormat221 = new CellFormat() { NumberFormatId = (UInt32Value)49U, FontId = (UInt32Value)5U, FillId = (UInt32Value)0U, BorderId = (UInt32Value)57U, FormatId = (UInt32Value)2U, ApplyBorder = true, ApplyAlignment = true };
            Alignment alignment221 = new Alignment() { Vertical = VerticalAlignmentValues.Center, ShrinkToFit = true };

            cellFormat221.Append(alignment221);

            CellFormat cellFormat222 = new CellFormat() { NumberFormatId = (UInt32Value)0U, FontId = (UInt32Value)9U, FillId = (UInt32Value)4U, BorderId = (UInt32Value)60U, FormatId = (UInt32Value)0U, ApplyFont = true, ApplyFill = true, ApplyBorder = true, ApplyAlignment = true };
            Alignment alignment222 = new Alignment() { Horizontal = HorizontalAlignmentValues.Center };
