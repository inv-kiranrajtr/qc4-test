...
namespace DiskCatalog.Classes
{
    public static class MessageBoxEx
    {
        ...
        public static DialogResult Warning(IWin32Window owner, string message)
        {
            _owner = owner;
            Initialize();
        ...
        public static DialogResult ErrorOk(IWin32Window owner, string message)
        {
            _owner = owner;
            Initialize();
        ...
        public static DialogResult ErrorOkCancel(IWin32Window owner, string message)
        {
            _owner = owner;
            Initialize();
        ...
        public static DialogResult Info(IWin32Window owner, string message, MessageBoxIcon icon = MessageBoxIcon.Information)
        {
            _owner = owner;
            Initialize();
            return MessageBox.Show(owner, message, Constants.MessageBoxTitle, MessageBoxButtons.OK, icon);
        }

        public static DialogResult InfoYesNo(IWin32Window owner, string message, MessageBoxIcon icon = MessageBoxIcon.Information)
        {
            _owner = owner;
            Initialize();
            return MessageBox.Show(owner, message, Constants.MessageBoxTitle, MessageBoxButtons.YesNo, icon);
        }
    ...
    public class Win32Window : IWin32Window
    {
		...
		public Win32Window(IntPtr _windowHandle)
		{
