...
namespace Macromill.QCWeb.Dao.CBean.BS {
    ...
    [System.Serializable]
    public class BsTOutputSettingFaCB : AbstractConditionBean {

        // ===============================================================================
        //                                                                       Attribute
        //                                                                       =========
        protected TOutputSettingFaCQ _conditionQuery;
        ...
        //                                                                           Query
        //                                                                           =====
        public TOutputSettingFaCQ Query() {
            return this.ConditionQuery;
        }

        public TOutputSettingFaCQ ConditionQuery {
            get {
        ...
        protected virtual TOutputSettingFaCQ CreateLocalCQ() {
            return xcreateCQ(null, this.SqlClause, this.SqlClause.getBasePointAliasName(), 0);
        }

        protected virtual TOutputSettingFaCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
            return new TOutputSettingFaCQ(childQuery, sqlClause, aliasName, nestLevel);
        }
        ...
        //                                                                           Union
        //                                                                           =====
	    public virtual void Union(UnionQuery<TOutputSettingFaCB> unionQuery) {
            TOutputSettingFaCB cb = new TOutputSettingFaCB();
            cb.xsetupForUnion(this); xsyncUQ(cb); unionQuery.Invoke(cb);
		    TOutputSettingFaCQ cq = cb.Query(); Query().xsetUnionQuery(cq);
        }

	    public virtual void UnionAll(UnionQuery<TOutputSettingFaCB> unionQuery) {
            TOutputSettingFaCB cb = new TOutputSettingFaCB();
            cb.xsetupForUnion(this); xsyncUQ(cb); unionQuery.Invoke(cb);
		    TOutputSettingFaCQ cq = cb.Query(); Query().xsetUnionAllQuery(cq);
	    }
        ...
        //                                                                         Specify
        //                                                                         =======
        protected TOutputSettingFaCBSpecification _specification;
        public TOutputSettingFaCBSpecification Specify() {
            if (_specification == null) { _specification = new TOutputSettingFaCBSpecification(this, new MySpQyCall(this), _forDerivedReferrer, _forScalarSelect, _forScalarCondition, _forColumnQuery); }
            return _specification;
        }
        protected bool HasSpecifiedColumn { get {
            return _specification != null && _specification.IsAlreadySpecifiedRequiredColumn;
        }}
        protected class MySpQyCall : HpSpQyCall<TOutputSettingFaCQ> {
			protected BsTOutputSettingFaCB _myCB;
			public MySpQyCall(BsTOutputSettingFaCB myCB) { _myCB = myCB; }
    		public bool has() { return true; } public TOutputSettingFaCQ qy() { return _myCB.Query(); }
    	}
        ...
        //                                                                     ColumnQuery
        //                                                                     ===========
        public HpColQyOperand<TOutputSettingFaCB> ColumnQuery(SpecifyQuery<TOutputSettingFaCB> leftSpecifyQuery) {
            return new HpColQyOperand<TOutputSettingFaCB>(delegate(SpecifyQuery<TOutputSettingFaCB> rightSp, String operand) {
                xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), leftSpecifyQuery, rightSp, operand);
            });
        }

        protected TOutputSettingFaCB xcreateColumnQueryCB() {
            TOutputSettingFaCB cb = new TOutputSettingFaCB();
            cb.xsetupForColumnQuery((TOutputSettingFaCB)this);
            return cb;
        }
        ...
        //                                                                    OrScopeQuery
        //                                                                    ============
        public void OrScopeQuery(OrQuery<TOutputSettingFaCB> orQuery) {
            xorQ((TOutputSettingFaCB)this, orQuery);
        }

        // ===============================================================================
        //                                                                    Purpose Type
        //                                                                    ============
        public void xsetupForColumnQuery(TOutputSettingFaCB mainCB) {
            ...
            Specify().xsetSyncQyCall(new TOutputSettingFaCBColQySpQyCall(mainCB));
        }
    }

    public class TOutputSettingFaCBColQySpQyCall : HpSpQyCall<TOutputSettingFaCQ> {
        protected TOutputSettingFaCB _mainCB;
        public TOutputSettingFaCBColQySpQyCall(TOutputSettingFaCB mainCB) {
            _mainCB = mainCB;
        }
        public bool has() { return true; } 
        public TOutputSettingFaCQ qy() { return _mainCB.Query(); } 
    }

    public class TOutputSettingFaCBSpecification : AbstractSpecification<TOutputSettingFaCQ> {
        ...
        public TOutputSettingFaCBSpecification(ConditionBean baseCB, HpSpQyCall<TOutputSettingFaCQ> qyCall
                                                      , bool forDerivedReferrer, bool forScalarSelect, bool forScalarSubQuery, bool forColumnQuery)
        : base(baseCB, qyCall, forDerivedReferrer, forScalarSelect, forScalarSubQuery, forColumnQuery) { }
        public void ColumnQcwebid() { doColumn("QCWEBID"); }
        public void ColumnPageSettingFlag() { doColumn("PAGE_SETTING_FLAG"); }
        ...
        protected override String getTableDbName() { return "T_OUTPUT_SETTING_FA"; }
		...
		public class TQcwebSurveyInfoSpQyCall : HpSpQyCall<TQcwebSurveyInfoCQ> {
		    protected HpSpQyCall<TOutputSettingFaCQ> _qyCall;
		    public TQcwebSurveyInfoSpQyCall(HpSpQyCall<TOutputSettingFaCQ> myQyCall) { _qyCall = myQyCall; }
		...
		public class TQcwebSurveyInfoAsOneSpQyCall : HpSpQyCall<TQcwebSurveyInfoCQ> {
		    protected HpSpQyCall<TOutputSettingFaCQ> _qyCall;
		    public TQcwebSurveyInfoAsOneSpQyCall(HpSpQyCall<TOutputSettingFaCQ> myQyCall) { _qyCall = myQyCall; }
