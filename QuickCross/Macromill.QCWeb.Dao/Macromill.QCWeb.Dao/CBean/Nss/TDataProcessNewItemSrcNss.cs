...
namespace Macromill.QCWeb.Dao.CBean.Nss {
    ...
    public class TDataProcessNewItemSrcNss {

        protected TDataProcessNewItemSrcCQ _query;
        public TDataProcessNewItemSrcNss(TDataProcessNewItemSrcCQ query) { _query = query; }
