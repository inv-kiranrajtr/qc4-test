...
namespace Macromill.QCWeb.Dao.CBean.Nss {
    ...
    public class TRawdataImportQueInfoNss {

        protected TRawdataImportQueInfoCQ _query;
        public TRawdataImportQueInfoNss(TRawdataImportQueInfoCQ query) { _query = query; }
