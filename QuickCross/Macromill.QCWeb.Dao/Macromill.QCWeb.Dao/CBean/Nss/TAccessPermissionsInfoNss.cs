...
namespace Macromill.QCWeb.Dao.CBean.Nss {
    ...
    public class TAccessPermissionsInfoNss {

        protected TAccessPermissionsInfoCQ _query;
        public TAccessPermissionsInfoNss(TAccessPermissionsInfoCQ query) { _query = query; }
