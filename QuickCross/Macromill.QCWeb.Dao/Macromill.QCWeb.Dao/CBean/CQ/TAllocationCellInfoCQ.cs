...
namespace Macromill.QCWeb.Dao.CBean.CQ {
    ...
    [System.Serializable]
    public class TAllocationCellInfoCQ : BsTAllocationCellInfoCQ {
        ...
        public TAllocationCellInfoCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
