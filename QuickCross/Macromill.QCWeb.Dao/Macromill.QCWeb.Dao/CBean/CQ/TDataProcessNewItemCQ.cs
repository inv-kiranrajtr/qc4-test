...
namespace Macromill.QCWeb.Dao.CBean.CQ {
    ...
    [System.Serializable]
    public class TDataProcessNewItemCQ : BsTDataProcessNewItemCQ {
        ...
        public TDataProcessNewItemCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
