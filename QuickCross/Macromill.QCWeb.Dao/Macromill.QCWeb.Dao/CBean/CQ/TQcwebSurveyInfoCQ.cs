...
namespace Macromill.QCWeb.Dao.CBean.CQ {
    ...
    [System.Serializable]
    public class TQcwebSurveyInfoCQ : BsTQcwebSurveyInfoCQ {
        ...
        public TQcwebSurveyInfoCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
