...
namespace Macromill.QCWeb.Dao.CBean.CQ {
    ...
    [System.Serializable]
    public class TQcwebSurveyDetailCQ : BsTQcwebSurveyDetailCQ {
        ...
        public TQcwebSurveyDetailCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
