...
namespace Macromill.QCWeb.Dao.CBean.CQ {
    ...
    [System.Serializable]
    public class TDefaultEnvColorInfoCCQ : BsTDefaultEnvColorInfoCCQ {
        ...
        public TDefaultEnvColorInfoCCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
