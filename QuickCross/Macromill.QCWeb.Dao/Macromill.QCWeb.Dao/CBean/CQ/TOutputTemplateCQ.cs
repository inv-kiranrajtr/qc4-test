...
namespace Macromill.QCWeb.Dao.CBean.CQ {
    ...
    [System.Serializable]
    public class TOutputTemplateCQ : BsTOutputTemplateCQ {
        ...
        public TOutputTemplateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
