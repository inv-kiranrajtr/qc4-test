...
namespace Macromill.QCWeb.Dao.CBean.CQ {
    ...
    [System.Serializable]
    public class TSelectConditionInfoCQ : BsTSelectConditionInfoCQ {
        ...
        public TSelectConditionInfoCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
