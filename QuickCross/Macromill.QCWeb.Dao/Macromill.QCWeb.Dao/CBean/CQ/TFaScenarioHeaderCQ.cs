...
namespace Macromill.QCWeb.Dao.CBean.CQ {
    ...
    [System.Serializable]
    public class TFaScenarioHeaderCQ : BsTFaScenarioHeaderCQ {
        ...
        public TFaScenarioHeaderCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
