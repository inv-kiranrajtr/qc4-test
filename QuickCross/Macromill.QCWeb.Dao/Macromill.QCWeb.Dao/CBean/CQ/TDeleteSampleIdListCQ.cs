...
namespace Macromill.QCWeb.Dao.CBean.CQ {
    ...
    [System.Serializable]
    public class TDeleteSampleIdListCQ : BsTDeleteSampleIdListCQ {
        ...
        public TDeleteSampleIdListCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
