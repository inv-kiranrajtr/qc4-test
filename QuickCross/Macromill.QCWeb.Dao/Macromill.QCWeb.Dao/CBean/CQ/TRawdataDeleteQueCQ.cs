...
namespace Macromill.QCWeb.Dao.CBean.CQ {
    ...
    [System.Serializable]
    public class TRawdataDeleteQueCQ : BsTRawdataDeleteQueCQ {
        ...
        public TRawdataDeleteQueCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
