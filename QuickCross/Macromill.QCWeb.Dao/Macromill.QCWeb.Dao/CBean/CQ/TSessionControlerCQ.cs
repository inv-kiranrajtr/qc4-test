...
namespace Macromill.QCWeb.Dao.CBean.CQ {
    ...
    [System.Serializable]
    public class TSessionControlerCQ : BsTSessionControlerCQ {
        ...
        public TSessionControlerCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
