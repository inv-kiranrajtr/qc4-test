...
namespace Macromill.QCWeb.Dao.CBean.CQ {
    ...
    [System.Serializable]
    public class TCrossScenarioTargetCQ : BsTCrossScenarioTargetCQ {
        ...
        public TCrossScenarioTargetCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
