...
namespace Macromill.QCWeb.Dao.CBean.CQ {
    ...
    [System.Serializable]
    public class TOutputSettingGtCQ : BsTOutputSettingGtCQ {
        ...
        public TOutputSettingGtCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
