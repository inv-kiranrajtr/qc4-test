...
namespace Macromill.QCWeb.Dao.CBean.CQ {
    ...
    [System.Serializable]
    public class TIntegConditionCQ : BsTIntegConditionCQ {
        ...
        public TIntegConditionCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
