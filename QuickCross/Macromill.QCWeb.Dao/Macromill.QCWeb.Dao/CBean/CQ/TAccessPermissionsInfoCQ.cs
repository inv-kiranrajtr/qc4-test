...
namespace Macromill.QCWeb.Dao.CBean.CQ {
    ...
    [System.Serializable]
    public class TAccessPermissionsInfoCQ : BsTAccessPermissionsInfoCQ {
        ...
        public TAccessPermissionsInfoCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
