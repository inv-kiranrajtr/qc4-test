...
namespace Macromill.QCWeb.Dao.CBean.CQ {
    ...
    [System.Serializable]
    public class TDefaultEnvColorInfoCQ : BsTDefaultEnvColorInfoCQ {
        ...
        public TDefaultEnvColorInfoCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
