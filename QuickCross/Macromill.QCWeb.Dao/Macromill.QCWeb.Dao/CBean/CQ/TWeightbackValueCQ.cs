...
namespace Macromill.QCWeb.Dao.CBean.CQ {
    ...
    [System.Serializable]
    public class TWeightbackValueCQ : BsTWeightbackValueCQ {
        ...
        public TWeightbackValueCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
