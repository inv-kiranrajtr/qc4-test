...
namespace Macromill.QCWeb.Dao.CBean.CQ {
    ...
    [System.Serializable]
    public class TOutputSettingFaCQ : BsTOutputSettingFaCQ {
        ...
        public TOutputSettingFaCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
