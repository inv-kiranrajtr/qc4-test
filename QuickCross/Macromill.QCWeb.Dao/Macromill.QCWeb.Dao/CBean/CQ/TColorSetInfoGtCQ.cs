...
namespace Macromill.QCWeb.Dao.CBean.CQ {
    ...
    [System.Serializable]
    public class TColorSetInfoGtCQ : BsTColorSetInfoGtCQ {
        ...
        public TColorSetInfoGtCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
