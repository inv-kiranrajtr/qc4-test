...
namespace Macromill.QCWeb.Dao.CBean.CQ {
    ...
    [System.Serializable]
    public class TColorSetInfoCrossCQ : BsTColorSetInfoCrossCQ {
        ...
        public TColorSetInfoCrossCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
