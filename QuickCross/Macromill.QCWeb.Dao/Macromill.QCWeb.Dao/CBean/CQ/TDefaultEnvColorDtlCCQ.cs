...
namespace Macromill.QCWeb.Dao.CBean.CQ {
    ...
    [System.Serializable]
    public class TDefaultEnvColorDtlCCQ : BsTDefaultEnvColorDtlCCQ {
        ...
        public TDefaultEnvColorDtlCCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
