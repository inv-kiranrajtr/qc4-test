...
namespace Macromill.QCWeb.Dao.CBean.CQ {
    ...
    [System.Serializable]
    public class TDeleteConditionCQ : BsTDeleteConditionCQ {
        ...
        public TDeleteConditionCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
