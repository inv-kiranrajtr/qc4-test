...
namespace Macromill.QCWeb.Dao.CBean.CQ {
    ...
    [System.Serializable]
    public class TDefaultEnvColorDtlCQ : BsTDefaultEnvColorDtlCQ {
        ...
        public TDefaultEnvColorDtlCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
