...
namespace Macromill.QCWeb.Dao.CBean.CQ.Ciq {
    ...
    [System.Serializable]
    public class TOutputSubCklistCIQ : AbstractBsTOutputSubCklistCQ {

        // ===============================================================================
        //                                                                       Attribute
        //                                                                       =========
        protected BsTOutputSubCklistCQ _myCQ;

        // ===============================================================================
        //                                                                     Constructor
        //                                                                     ===========
        public TOutputSubCklistCIQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel, BsTOutputSubCklistCQ myCQ)
        ...
        protected override ConditionValue getCValueOutputSubCklistId() {
            return _myCQ.OutputSubCklistId;
        }
        ...
        protected override ConditionValue getCValueTotalCount() {
            return _myCQ.TotalCount;
        }
