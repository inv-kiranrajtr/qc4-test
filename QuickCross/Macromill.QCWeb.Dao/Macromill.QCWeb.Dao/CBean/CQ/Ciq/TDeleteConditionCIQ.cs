...
namespace Macromill.QCWeb.Dao.CBean.CQ.Ciq {
    ...
    [System.Serializable]
    public class TDeleteConditionCIQ : AbstractBsTDeleteConditionCQ {

        // ===============================================================================
        //                                                                       Attribute
        //                                                                       =========
        protected BsTDeleteConditionCQ _myCQ;

        // ===============================================================================
        //                                                                     Constructor
        //                                                                     ===========
        public TDeleteConditionCIQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel, BsTDeleteConditionCQ myCQ)
        ...
        protected override ConditionValue getCValueDeleteConditionId() {
            return _myCQ.DeleteConditionId;
        }
