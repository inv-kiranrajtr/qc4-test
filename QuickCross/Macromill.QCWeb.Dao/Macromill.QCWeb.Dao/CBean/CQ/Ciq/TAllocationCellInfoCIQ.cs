...
namespace Macromill.QCWeb.Dao.CBean.CQ.Ciq {
    ...
    [System.Serializable]
    public class TAllocationCellInfoCIQ : AbstractBsTAllocationCellInfoCQ {

        // ===============================================================================
        //                                                                       Attribute
        //                                                                       =========
        protected BsTAllocationCellInfoCQ _myCQ;

        // ===============================================================================
        //                                                                     Constructor
        //                                                                     ===========
        public TAllocationCellInfoCIQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel, BsTAllocationCellInfoCQ myCQ)
        ...
        protected override ConditionValue getCValueAllocationCellId() {
            return _myCQ.AllocationCellId;
        }
        ...
        protected override ConditionValue getCValueCellNo() {
            return _myCQ.CellNo;
        }
        ...
        protected override ConditionValue getCValueExpectationSampleCount() {
            return _myCQ.ExpectationSampleCount;
        }


        protected override ConditionValue getCValueValidSampleCount() {
            return _myCQ.ValidSampleCount;
        }
