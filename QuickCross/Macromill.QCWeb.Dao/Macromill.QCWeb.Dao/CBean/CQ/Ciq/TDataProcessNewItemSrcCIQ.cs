...
namespace Macromill.QCWeb.Dao.CBean.CQ.Ciq {
    ...
    [System.Serializable]
    public class TDataProcessNewItemSrcCIQ : AbstractBsTDataProcessNewItemSrcCQ {

        // ===============================================================================
        //                                                                       Attribute
        //                                                                       =========
        protected BsTDataProcessNewItemSrcCQ _myCQ;

        // ===============================================================================
        //                                                                     Constructor
        //                                                                     ===========
        public TDataProcessNewItemSrcCIQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel, BsTDataProcessNewItemSrcCQ myCQ)
        ...
        protected override ConditionValue getCValueDataProcessNewItemSrcId() {
            return _myCQ.DataProcessNewItemSrcId;
        }
        ...
        protected override ConditionValue getCValueTargetFlag() {
            return _myCQ.TargetFlag;
        }
