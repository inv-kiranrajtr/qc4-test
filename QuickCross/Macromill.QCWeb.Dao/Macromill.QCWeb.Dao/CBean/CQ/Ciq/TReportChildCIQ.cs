...
namespace Macromill.QCWeb.Dao.CBean.CQ.Ciq {
    ...
    [System.Serializable]
    public class TReportChildCIQ : AbstractBsTReportChildCQ {

        // ===============================================================================
        //                                                                       Attribute
        //                                                                       =========
        protected BsTReportChildCQ _myCQ;

        // ===============================================================================
        //                                                                     Constructor
        //                                                                     ===========
        public TReportChildCIQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel, BsTReportChildCQ myCQ)
        ...
        protected override ConditionValue getCValueReportChildId() {
            return _myCQ.ReportChildId;
        }


        protected override ConditionValue getCValueParentReportId() {
            return _myCQ.ParentReportId;
        }


        public override String keepParentReportId_InScopeSubQuery_TReport(TReportCQ subQuery) {
            return _myCQ.keepParentReportId_InScopeSubQuery_TReport(subQuery);
        }

        public override String keepParentReportId_NotInScopeSubQuery_TReport(TReportCQ subQuery) {
            return _myCQ.keepParentReportId_NotInScopeSubQuery_TReport(subQuery);
        }
