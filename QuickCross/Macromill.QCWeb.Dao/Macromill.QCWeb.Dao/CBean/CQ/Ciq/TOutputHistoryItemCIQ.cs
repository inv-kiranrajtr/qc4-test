...
namespace Macromill.QCWeb.Dao.CBean.CQ.Ciq {
    ...
    [System.Serializable]
    public class TOutputHistoryItemCIQ : AbstractBsTOutputHistoryItemCQ {

        // ===============================================================================
        //                                                                       Attribute
        //                                                                       =========
        protected BsTOutputHistoryItemCQ _myCQ;

        // ===============================================================================
        //                                                                     Constructor
        //                                                                     ===========
        public TOutputHistoryItemCIQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel, BsTOutputHistoryItemCQ myCQ)
        ...
        protected override ConditionValue getCValueOutputHistoryItemId() {
            return _myCQ.OutputHistoryItemId;
        }
        ...
        public override String keepQcwebid_InScopeSubQuery_TOutputSetting(TOutputSettingCQ subQuery) {
            return _myCQ.keepQcwebid_InScopeSubQuery_TOutputSetting(subQuery);
        }

        public override String keepQcwebid_NotInScopeSubQuery_TOutputSetting(TOutputSettingCQ subQuery) {
            return _myCQ.keepQcwebid_NotInScopeSubQuery_TOutputSetting(subQuery);
        }
        ...
        protected override ConditionValue getCValueOutputFlag() {
            return _myCQ.OutputFlag;
        }
