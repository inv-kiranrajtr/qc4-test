...
namespace Macromill.QCWeb.Dao.CBean.CQ.Ciq {
    ...
    [System.Serializable]
    public class TDeleteDataCIQ : AbstractBsTDeleteDataCQ {

        // ===============================================================================
        //                                                                       Attribute
        //                                                                       =========
        protected BsTDeleteDataCQ _myCQ;

        // ===============================================================================
        //                                                                     Constructor
        //                                                                     ===========
        public TDeleteDataCIQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel, BsTDeleteDataCQ myCQ)
        ...
        public override String keepDataEditId_InScopeSubQuery_TDeleteConditionList(TDeleteConditionCQ subQuery) {
            return _myCQ.keepDataEditId_InScopeSubQuery_TDeleteConditionList(subQuery);
        }

        public override String keepDataEditId_InScopeSubQuery_TDeleteSampleIdListList(TDeleteSampleIdListCQ subQuery) {
            return _myCQ.keepDataEditId_InScopeSubQuery_TDeleteSampleIdListList(subQuery);
        }
        ...
        public override String keepDataEditId_NotInScopeSubQuery_TDeleteConditionList(TDeleteConditionCQ subQuery) {
            return _myCQ.keepDataEditId_NotInScopeSubQuery_TDeleteConditionList(subQuery);
        }

        public override String keepDataEditId_NotInScopeSubQuery_TDeleteSampleIdListList(TDeleteSampleIdListCQ subQuery) {
            return _myCQ.keepDataEditId_NotInScopeSubQuery_TDeleteSampleIdListList(subQuery);
        }
        ...
        protected override ConditionValue getCValueDeleteType() {
            return _myCQ.DeleteType;
        }
