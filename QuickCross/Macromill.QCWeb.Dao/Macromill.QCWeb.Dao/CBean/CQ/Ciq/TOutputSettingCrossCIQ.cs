...
namespace Macromill.QCWeb.Dao.CBean.CQ.Ciq {
    ...
    [System.Serializable]
    public class TOutputSettingCrossCIQ : AbstractBsTOutputSettingCrossCQ {

        // ===============================================================================
        //                                                                       Attribute
        //                                                                       =========
        protected BsTOutputSettingCrossCQ _myCQ;

        // ===============================================================================
        //                                                                     Constructor
        //                                                                     ===========
        public TOutputSettingCrossCIQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel, BsTOutputSettingCrossCQ myCQ)
        ...
        protected override ConditionValue getCValueCrossNpFlag() {
            return _myCQ.CrossNpFlag;
        }


        protected override ConditionValue getCValueCrossNFlag() {
            return _myCQ.CrossNFlag;
        }


        protected override ConditionValue getCValueCrossPFlag() {
            return _myCQ.CrossPFlag;
        }
