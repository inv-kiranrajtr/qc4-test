...
namespace Macromill.QCWeb.Dao.CBean.CQ.Ciq {
    ...
    [System.Serializable]
    public class TCategoryInfoCIQ : AbstractBsTCategoryInfoCQ {

        // ===============================================================================
        //                                                                       Attribute
        //                                                                       =========
        protected BsTCategoryInfoCQ _myCQ;

        // ===============================================================================
        //                                                                     Constructor
        //                                                                     ===========
        public TCategoryInfoCIQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel, BsTCategoryInfoCQ myCQ)
        ...
        protected override ConditionValue getCValueCategoryNo() {
            return _myCQ.CategoryNo;
        }


        protected override ConditionValue getCValueCategoryName() {
            return _myCQ.CategoryName;
        }


        protected override ConditionValue getCValueWeightValue() {
            return _myCQ.WeightValue;
        }


        protected override ConditionValue getCValueOriginalCategoryName() {
            return _myCQ.OriginalCategoryName;
        }


        protected override ConditionValue getCValueOriginalWeightValue() {
            return _myCQ.OriginalWeightValue;
        }
