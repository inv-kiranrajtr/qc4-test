...
namespace Macromill.QCWeb.Dao.CBean.CQ.Ciq {
    ...
    [System.Serializable]
    public class TAccessPermissionsInfoCIQ : AbstractBsTAccessPermissionsInfoCQ {

        // ===============================================================================
        //                                                                       Attribute
        //                                                                       =========
        protected BsTAccessPermissionsInfoCQ _myCQ;

        // ===============================================================================
        //                                                                     Constructor
        //                                                                     ===========
        public TAccessPermissionsInfoCIQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel, BsTAccessPermissionsInfoCQ myCQ)
        ...
        protected override ConditionValue getCValueAccessDatetime() {
            return _myCQ.AccessDatetime;
        }


        protected override ConditionValue getCValueClientId() {
            return _myCQ.ClientId;
        }


        protected override ConditionValue getCValueAdminId() {
            return _myCQ.AdminId;
        }


        protected override ConditionValue getCValueGuestId() {
            return _myCQ.GuestId;
        }
