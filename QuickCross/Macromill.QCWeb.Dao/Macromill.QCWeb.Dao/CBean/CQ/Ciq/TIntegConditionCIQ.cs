...
namespace Macromill.QCWeb.Dao.CBean.CQ.Ciq {
    ...
    [System.Serializable]
    public class TIntegConditionCIQ : AbstractBsTIntegConditionCQ {

        // ===============================================================================
        //                                                                       Attribute
        //                                                                       =========
        protected BsTIntegConditionCQ _myCQ;

        // ===============================================================================
        //                                                                     Constructor
        //                                                                     ===========
        public TIntegConditionCIQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel, BsTIntegConditionCQ myCQ)
        ...
        protected override ConditionValue getCValueIntegConditionId() {
            return _myCQ.IntegConditionId;
        }


        protected override ConditionValue getCValueConditionNo() {
            return _myCQ.ConditionNo;
        }
        ...
        protected override ConditionValue getCValueSourceItemNo() {
            return _myCQ.SourceItemNo;
        }
