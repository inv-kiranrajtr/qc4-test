...
namespace Macromill.QCWeb.Dao.CBean.CQ.Ciq {
    ...
    [System.Serializable]
    public class TDefaultEnvBaseCIQ : AbstractBsTDefaultEnvBaseCQ {

        // ===============================================================================
        //                                                                       Attribute
        //                                                                       =========
        protected BsTDefaultEnvBaseCQ _myCQ;

        // ===============================================================================
        //                                                                     Constructor
        //                                                                     ===========
        public TDefaultEnvBaseCIQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel, BsTDefaultEnvBaseCQ myCQ)
        ...
        public override String keepLanguage_ExistsSubQuery_TDefaultEnvColorInfoCList(TDefaultEnvColorInfoCCQ subQuery) {
            ...
            // _myCQ.keepLanguage_ExistsSubQuery_TDefaultEnvColorInfoCList(subQuery);
        }
        ...
        public override String keepLanguage_NotExistsSubQuery_TDefaultEnvColorInfoCList(TDefaultEnvColorInfoCCQ subQuery) {
            ...
            // _myCQ.keepLanguage_NotExistsSubQuery_TDefaultEnvColorInfoCList(subQuery);
        }

        public override String keepLanguage_InScopeSubQuery_TDefaultEnvColorInfoCList(TDefaultEnvColorInfoCCQ subQuery) {
            return _myCQ.keepLanguage_InScopeSubQuery_TDefaultEnvColorInfoCList(subQuery);
        }

        public override String keepLanguage_NotInScopeSubQuery_TDefaultEnvColorInfoCList(TDefaultEnvColorInfoCCQ subQuery) {
            return _myCQ.keepLanguage_NotInScopeSubQuery_TDefaultEnvColorInfoCList(subQuery);
        }
