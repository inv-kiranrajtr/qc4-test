...
namespace Macromill.QCWeb.Dao.CBean.CQ.Ciq {
    ...
    [System.Serializable]
    public class TOutputSubCrossCIQ : AbstractBsTOutputSubCrossCQ {

        // ===============================================================================
        //                                                                       Attribute
        //                                                                       =========
        protected BsTOutputSubCrossCQ _myCQ;

        // ===============================================================================
        //                                                                     Constructor
        //                                                                     ===========
        public TOutputSubCrossCIQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel, BsTOutputSubCrossCQ myCQ)
        ...
        protected override ConditionValue getCValueOutputSubCrossId() {
            return _myCQ.OutputSubCrossId;
        }
        ...
        protected override ConditionValue getCValueLevel2pluscolor() {
            return _myCQ.Level2pluscolor;
        }


        protected override ConditionValue getCValueLevel1pluscolor() {
            return _myCQ.Level1pluscolor;
        }


        protected override ConditionValue getCValueLevel1minuscolor() {
            return _myCQ.Level1minuscolor;
        }


        protected override ConditionValue getCValueLevel2minuscolor() {
            return _myCQ.Level2minuscolor;
        }


        protected override ConditionValue getCValueLevel2percent() {
            return _myCQ.Level2percent;
        }


        protected override ConditionValue getCValueLevel1percent() {
            return _myCQ.Level1percent;
        }
