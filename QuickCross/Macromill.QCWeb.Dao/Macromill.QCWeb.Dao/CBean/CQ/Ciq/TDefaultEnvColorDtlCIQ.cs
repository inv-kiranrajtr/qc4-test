...
namespace Macromill.QCWeb.Dao.CBean.CQ.Ciq {
    ...
    [System.Serializable]
    public class TDefaultEnvColorDtlCIQ : AbstractBsTDefaultEnvColorDtlCQ {

        // ===============================================================================
        //                                                                       Attribute
        //                                                                       =========
        protected BsTDefaultEnvColorDtlCQ _myCQ;

        // ===============================================================================
        //                                                                     Constructor
        //                                                                     ===========
        public TDefaultEnvColorDtlCIQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel, BsTDefaultEnvColorDtlCQ myCQ)
        ...
        protected override ConditionValue getCValueDefEnvColorDtlId() {
            return _myCQ.DefEnvColorDtlId;
        }
        ...
        public override String keepDefEnvColorInfoId_InScopeSubQuery_TDefaultEnvColorInfo(TDefaultEnvColorInfoCQ subQuery) {
            return _myCQ.keepDefEnvColorInfoId_InScopeSubQuery_TDefaultEnvColorInfo(subQuery);
        }

        public override String keepDefEnvColorInfoId_NotInScopeSubQuery_TDefaultEnvColorInfo(TDefaultEnvColorInfoCQ subQuery) {
            return _myCQ.keepDefEnvColorInfoId_NotInScopeSubQuery_TDefaultEnvColorInfo(subQuery);
        }
