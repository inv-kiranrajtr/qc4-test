...
namespace Macromill.QCWeb.Dao.CBean.CQ.Ciq {
    ...
    [System.Serializable]
    public class TEditMenuMasterCIQ : AbstractBsTEditMenuMasterCQ {

        // ===============================================================================
        //                                                                       Attribute
        //                                                                       =========
        protected BsTEditMenuMasterCQ _myCQ;

        // ===============================================================================
        //                                                                     Constructor
        //                                                                     ===========
        public TEditMenuMasterCIQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel, BsTEditMenuMasterCQ myCQ)
        ...
        protected override ConditionValue getCValueEditClassification() {
            return _myCQ.EditClassification;
        }


        protected override ConditionValue getCValueProcessType() {
            return _myCQ.ProcessType;
        }


        protected override ConditionValue getCValueExplanation() {
            return _myCQ.Explanation;
        }


        protected override ConditionValue getCValueExample() {
            return _myCQ.Example;
        }


        protected override ConditionValue getCValueDetailedexplanation() {
            return _myCQ.Detailedexplanation;
        }
        ...
        protected override ConditionValue getCValueTypeBitUnion() {
            return _myCQ.TypeBitUnion;
        }
