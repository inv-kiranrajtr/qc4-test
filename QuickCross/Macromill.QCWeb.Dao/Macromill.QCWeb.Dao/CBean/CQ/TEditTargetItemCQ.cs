...
namespace Macromill.QCWeb.Dao.CBean.CQ {
    ...
    [System.Serializable]
    public class TEditTargetItemCQ : BsTEditTargetItemCQ {
        ...
        public TEditTargetItemCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
