...
namespace Macromill.QCWeb.Dao.CBean.CQ {
    ...
    [System.Serializable]
    public class TPolylineCategoryListCQ : BsTPolylineCategoryListCQ {
        ...
        public TPolylineCategoryListCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
