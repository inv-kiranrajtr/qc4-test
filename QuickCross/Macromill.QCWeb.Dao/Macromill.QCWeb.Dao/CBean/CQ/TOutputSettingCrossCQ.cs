...
namespace Macromill.QCWeb.Dao.CBean.CQ {
    ...
    [System.Serializable]
    public class TOutputSettingCrossCQ : BsTOutputSettingCrossCQ {
        ...
        public TOutputSettingCrossCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
