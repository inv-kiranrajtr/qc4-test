...
namespace Macromill.QCWeb.Dao.CBean.CQ {
    ...
    [System.Serializable]
    public class TTableDetailInfoCQ : BsTTableDetailInfoCQ {
        ...
        public TTableDetailInfoCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
