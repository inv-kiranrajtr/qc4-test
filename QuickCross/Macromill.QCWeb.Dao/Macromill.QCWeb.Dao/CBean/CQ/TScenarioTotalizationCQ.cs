...
namespace Macromill.QCWeb.Dao.CBean.CQ {
    ...
    [System.Serializable]
    public class TScenarioTotalizationCQ : BsTScenarioTotalizationCQ {
        ...
        public TScenarioTotalizationCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
