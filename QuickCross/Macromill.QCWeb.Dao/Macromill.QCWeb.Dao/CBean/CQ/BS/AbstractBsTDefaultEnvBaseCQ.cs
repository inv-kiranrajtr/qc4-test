...
namespace Macromill.QCWeb.Dao.CBean.CQ.BS {
    ...
    [System.Serializable]
    public abstract class AbstractBsTDefaultEnvBaseCQ : AbstractConditionQuery {

        public AbstractBsTDefaultEnvBaseCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
            : base(childQuery, sqlClause, aliasName, nestLevel) {}

        public override String getTableDbName() { return "T_DEFAULT_ENV_BASE"; }
        public override String getTableSqlName() { return "T_DEFAULT_ENV_BASE"; }
        ...
        public void ExistsTDefaultEnvColorInfoCList(SubQuery<TDefaultEnvColorInfoCCB> subQuery) {
            WhereSetterFlag = true;    // 2013/02/21 Add cterash
            assertObjectNotNull("subQuery<TDefaultEnvColorInfoCCB>", subQuery);
            TDefaultEnvColorInfoCCB cb = new TDefaultEnvColorInfoCCB(); cb.xsetupForExistsReferrer(this); subQuery.Invoke(cb);
            String subQueryPropertyName = keepLanguage_ExistsSubQuery_TDefaultEnvColorInfoCList(cb.Query());
            registerExistsSubQuery(cb.Query(), "LANGUAGE", "LANGUAGE", subQueryPropertyName);
        }
        public abstract String keepLanguage_ExistsSubQuery_TDefaultEnvColorInfoCList(TDefaultEnvColorInfoCCQ subQuery);
        public void NotExistsTDefaultEnvColorInfoCList(SubQuery<TDefaultEnvColorInfoCCB> subQuery) {
            WhereSetterFlag = true;    // 2013/02/21 Add cterash
            assertObjectNotNull("subQuery<TDefaultEnvColorInfoCCB>", subQuery);
            TDefaultEnvColorInfoCCB cb = new TDefaultEnvColorInfoCCB(); cb.xsetupForExistsReferrer(this); subQuery.Invoke(cb);
            String subQueryPropertyName = keepLanguage_NotExistsSubQuery_TDefaultEnvColorInfoCList(cb.Query());
            registerNotExistsSubQuery(cb.Query(), "LANGUAGE", "LANGUAGE", subQueryPropertyName);
        }
        public abstract String keepLanguage_NotExistsSubQuery_TDefaultEnvColorInfoCList(TDefaultEnvColorInfoCCQ subQuery);
        public void InScopeTDefaultEnvColorInfoCList(SubQuery<TDefaultEnvColorInfoCCB> subQuery) {
            WhereSetterFlag = true;    // 2013/02/21 Add cterash
            assertObjectNotNull("subQuery<TDefaultEnvColorInfoCCB>", subQuery);
            TDefaultEnvColorInfoCCB cb = new TDefaultEnvColorInfoCCB(); cb.xsetupForInScopeRelation(this); subQuery.Invoke(cb);
            String subQueryPropertyName = keepLanguage_InScopeSubQuery_TDefaultEnvColorInfoCList(cb.Query());
            registerInScopeSubQuery(cb.Query(), "LANGUAGE", "LANGUAGE", subQueryPropertyName);
        }
        public abstract String keepLanguage_InScopeSubQuery_TDefaultEnvColorInfoCList(TDefaultEnvColorInfoCCQ subQuery);
        public void NotInScopeTDefaultEnvColorInfoCList(SubQuery<TDefaultEnvColorInfoCCB> subQuery) {
            WhereSetterFlag = true;    // 2013/02/21 Add cterash
            assertObjectNotNull("subQuery<TDefaultEnvColorInfoCCB>", subQuery);
            TDefaultEnvColorInfoCCB cb = new TDefaultEnvColorInfoCCB(); cb.xsetupForInScopeRelation(this); subQuery.Invoke(cb);
            String subQueryPropertyName = keepLanguage_NotInScopeSubQuery_TDefaultEnvColorInfoCList(cb.Query());
            registerNotInScopeSubQuery(cb.Query(), "LANGUAGE", "LANGUAGE", subQueryPropertyName);
        }
        public abstract String keepLanguage_NotInScopeSubQuery_TDefaultEnvColorInfoCList(TDefaultEnvColorInfoCCQ subQuery);
        public void xsderiveTDefaultEnvColorInfoCList(String function, SubQuery<TDefaultEnvColorInfoCCB> subQuery, String aliasName) {
            assertObjectNotNull("subQuery<TDefaultEnvColorInfoCCB>", subQuery);
            TDefaultEnvColorInfoCCB cb = new TDefaultEnvColorInfoCCB(); cb.xsetupForDerivedReferrer(this); subQuery.Invoke(cb);
            String subQueryPropertyName = keepLanguage_SpecifyDerivedReferrer_TDefaultEnvColorInfoCList(cb.Query());
            registerSpecifyDerivedReferrer(function, cb.Query(), "LANGUAGE", "LANGUAGE", subQueryPropertyName, aliasName);
        }
        abstract public String keepLanguage_SpecifyDerivedReferrer_TDefaultEnvColorInfoCList(TDefaultEnvColorInfoCCQ subQuery);

        public QDRFunction<TDefaultEnvColorInfoCCB> DerivedTDefaultEnvColorInfoCList() {
            return xcreateQDRFunctionTDefaultEnvColorInfoCList();
        }
        protected QDRFunction<TDefaultEnvColorInfoCCB> xcreateQDRFunctionTDefaultEnvColorInfoCList() {
            return new QDRFunction<TDefaultEnvColorInfoCCB>(delegate(String function, SubQuery<TDefaultEnvColorInfoCCB> subQuery, String operand, Object value) {
                xqderiveTDefaultEnvColorInfoCList(function, subQuery, operand, value);
            });
        }
        public void xqderiveTDefaultEnvColorInfoCList(String function, SubQuery<TDefaultEnvColorInfoCCB> subQuery, String operand, Object value) {
            assertObjectNotNull("subQuery<TDefaultEnvColorInfoCCB>", subQuery);
            TDefaultEnvColorInfoCCB cb = new TDefaultEnvColorInfoCCB(); cb.xsetupForDerivedReferrer(this); subQuery.Invoke(cb);
            String subQueryPropertyName = keepLanguage_QueryDerivedReferrer_TDefaultEnvColorInfoCList(cb.Query()); // for saving query-value.
            String parameterPropertyName = keepLanguage_QueryDerivedReferrer_TDefaultEnvColorInfoCListParameter(value);
            registerQueryDerivedReferrer(function, cb.Query(), "LANGUAGE", "LANGUAGE", subQueryPropertyName, operand, value, parameterPropertyName);
        }
        public abstract String keepLanguage_QueryDerivedReferrer_TDefaultEnvColorInfoCList(TDefaultEnvColorInfoCCQ subQuery);
        public abstract String keepLanguage_QueryDerivedReferrer_TDefaultEnvColorInfoCListParameter(Object parameterValue);
        public void SetLanguage_IsNull() {
            WhereSetterFlag = true;    // 2013/02/21 Add cterash
            regLanguage(CK_ISN, DUMMY_OBJECT);
        }
        public void SetLanguage_IsNotNull() {
            WhereSetterFlag = true;    // 2013/02/21 Add cterash
            regLanguage(CK_ISNN, DUMMY_OBJECT);
        }
        ...
        //                                                                    Scalar Condition
        //                                                                    ================
        public SSQFunction<TDefaultEnvBaseCB> Scalar_Equal() {
            return xcreateSSQFunction("=");
        }

        public SSQFunction<TDefaultEnvBaseCB> Scalar_NotEqual() {
            return xcreateSSQFunction("<>");
        }

        public SSQFunction<TDefaultEnvBaseCB> Scalar_GreaterEqual() {
            return xcreateSSQFunction(">=");
        }

        public SSQFunction<TDefaultEnvBaseCB> Scalar_GreaterThan() {
            return xcreateSSQFunction(">");
        }

        public SSQFunction<TDefaultEnvBaseCB> Scalar_LessEqual() {
            return xcreateSSQFunction("<=");
        }

        public SSQFunction<TDefaultEnvBaseCB> Scalar_LessThan() {
            return xcreateSSQFunction("<");
        }

        protected SSQFunction<TDefaultEnvBaseCB> xcreateSSQFunction(String operand) {
            return new SSQFunction<TDefaultEnvBaseCB>(delegate(String function, SubQuery<TDefaultEnvBaseCB> subQuery) {
                xscalarSubQuery(function, subQuery, operand);
            });
        }

        protected void xscalarSubQuery(String function, SubQuery<TDefaultEnvBaseCB> subQuery, String operand) {
            assertObjectNotNull("subQuery<TDefaultEnvBaseCB>", subQuery);
            TDefaultEnvBaseCB cb = new TDefaultEnvBaseCB(); cb.xsetupForScalarCondition(this); subQuery.Invoke(cb);
            String subQueryPropertyName = keepScalarSubQuery(cb.Query()); // for saving query-value.
            registerScalarSubQuery(function, cb.Query(), subQueryPropertyName, operand);
        }
        public abstract String keepScalarSubQuery(TDefaultEnvBaseCQ subQuery);

        // ===============================================================================
        //                                                                  MySelf InScope
        //                                                                  ==============
        public void MyselfInScope(SubQuery<TDefaultEnvBaseCB> subQuery) {
            WhereSetterFlag = true;    // 2013/02/21 Add cterash
            assertObjectNotNull("subQuery<TDefaultEnvBaseCB>", subQuery);
        ...
        public abstract String keepMyselfInScopeSubQuery(TDefaultEnvBaseCQ subQuery);
