...
namespace Macromill.QCWeb.Dao.CBean.CQ {
    ...
    [System.Serializable]
    public class TDataProcessNewItemSrcCQ : BsTDataProcessNewItemSrcCQ {
        ...
        public TDataProcessNewItemSrcCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
