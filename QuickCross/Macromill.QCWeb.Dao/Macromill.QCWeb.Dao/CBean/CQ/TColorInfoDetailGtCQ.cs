...
namespace Macromill.QCWeb.Dao.CBean.CQ {
    ...
    [System.Serializable]
    public class TColorInfoDetailGtCQ : BsTColorInfoDetailGtCQ {
        ...
        public TColorInfoDetailGtCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
