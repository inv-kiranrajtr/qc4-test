...
namespace Macromill.QCWeb.Dao.CBean.CQ {
    ...
    [System.Serializable]
    public class TDataProcessNewCategoryCQ : BsTDataProcessNewCategoryCQ {
        ...
        public TDataProcessNewCategoryCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
