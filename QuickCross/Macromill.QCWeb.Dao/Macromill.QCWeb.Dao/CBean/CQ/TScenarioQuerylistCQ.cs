...
namespace Macromill.QCWeb.Dao.CBean.CQ {
    ...
    [System.Serializable]
    public class TScenarioQuerylistCQ : BsTScenarioQuerylistCQ {
        ...
        public TScenarioQuerylistCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
