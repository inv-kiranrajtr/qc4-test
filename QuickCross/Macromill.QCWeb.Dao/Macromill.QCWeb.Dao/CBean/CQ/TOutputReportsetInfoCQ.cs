...
namespace Macromill.QCWeb.Dao.CBean.CQ {
    ...
    [System.Serializable]
    public class TOutputReportsetInfoCQ : BsTOutputReportsetInfoCQ {
        ...
        public TOutputReportsetInfoCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
