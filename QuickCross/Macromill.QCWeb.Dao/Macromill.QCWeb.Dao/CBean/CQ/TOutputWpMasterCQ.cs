...
namespace Macromill.QCWeb.Dao.CBean.CQ {
    ...
    [System.Serializable]
    public class TOutputWpMasterCQ : BsTOutputWpMasterCQ {
        ...
        public TOutputWpMasterCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
