...
namespace Macromill.QCWeb.Dao.CBean.CQ {
    ...
    [System.Serializable]
    public class TOutputSubCklistCQ : BsTOutputSubCklistCQ {
        ...
        public TOutputSubCklistCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
