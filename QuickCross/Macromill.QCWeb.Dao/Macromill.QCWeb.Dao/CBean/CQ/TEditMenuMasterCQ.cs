...
namespace Macromill.QCWeb.Dao.CBean.CQ {
    ...
    [System.Serializable]
    public class TEditMenuMasterCQ : BsTEditMenuMasterCQ {
        ...
        public TEditMenuMasterCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
