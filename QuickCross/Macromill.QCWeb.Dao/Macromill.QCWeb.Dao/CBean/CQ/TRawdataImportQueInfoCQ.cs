...
namespace Macromill.QCWeb.Dao.CBean.CQ {
    ...
    [System.Serializable]
    public class TRawdataImportQueInfoCQ : BsTRawdataImportQueInfoCQ {
        ...
        public TRawdataImportQueInfoCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
