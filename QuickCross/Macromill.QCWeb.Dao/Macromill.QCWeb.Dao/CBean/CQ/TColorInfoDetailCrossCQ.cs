...
namespace Macromill.QCWeb.Dao.CBean.CQ {
    ...
    [System.Serializable]
    public class TColorInfoDetailCrossCQ : BsTColorInfoDetailCrossCQ {
        ...
        public TColorInfoDetailCrossCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
