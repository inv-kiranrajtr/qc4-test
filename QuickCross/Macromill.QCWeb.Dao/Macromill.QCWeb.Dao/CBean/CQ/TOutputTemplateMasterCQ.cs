...
namespace Macromill.QCWeb.Dao.CBean.CQ {
    ...
    [System.Serializable]
    public class TOutputTemplateMasterCQ : BsTOutputTemplateMasterCQ {
        ...
        public TOutputTemplateMasterCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
