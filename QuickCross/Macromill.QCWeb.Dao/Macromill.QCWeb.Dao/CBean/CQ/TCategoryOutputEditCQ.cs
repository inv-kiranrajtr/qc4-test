...
namespace Macromill.QCWeb.Dao.CBean.CQ {
    ...
    [System.Serializable]
    public class TCategoryOutputEditCQ : BsTCategoryOutputEditCQ {
        ...
        public TCategoryOutputEditCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
