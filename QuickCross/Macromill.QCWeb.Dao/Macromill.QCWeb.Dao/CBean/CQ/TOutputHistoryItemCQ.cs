...
namespace Macromill.QCWeb.Dao.CBean.CQ {
    ...
    [System.Serializable]
    public class TOutputHistoryItemCQ : BsTOutputHistoryItemCQ {
        ...
        public TOutputHistoryItemCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
