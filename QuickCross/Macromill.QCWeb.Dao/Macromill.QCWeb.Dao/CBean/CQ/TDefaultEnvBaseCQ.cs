...
namespace Macromill.QCWeb.Dao.CBean.CQ {
    ...
    [System.Serializable]
    public class TDefaultEnvBaseCQ : BsTDefaultEnvBaseCQ {
        ...
        public TDefaultEnvBaseCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
