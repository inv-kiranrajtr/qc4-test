...
namespace Macromill.QCWeb.Dao.CBean.CQ {
    ...
    [System.Serializable]
    public class TOutputSettingReportCQ : BsTOutputSettingReportCQ {
        ...
        public TOutputSettingReportCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
