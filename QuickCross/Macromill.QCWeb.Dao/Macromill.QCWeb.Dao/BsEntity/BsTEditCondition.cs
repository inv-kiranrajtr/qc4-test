...
namespace Macromill.QCWeb.Dao.ExEntity {
    ...
    /// <summary>
    /// The entity of T_EDIT_CONDITION as TABLE. (partial class for auto-generation)
    /// <![CDATA[
    /// [primary-key]
    ///     EDIT_CONDITION_ID
    /// 
    /// [column]
    ///     EDIT_CONDITION_ID, SORT_NO, ITEM_ID, OPERATION_CODE, OPERATION_VALUE, DATA_EDIT_ID
    /// 
    /// [sequence]
    ///     T_Edit_Condition_SEQ_01
    /// 
    /// [identity]
    ///     
    /// 
    ...
    /// </summary>
    [Seasar.Dao.Attrs.Table("T_EDIT_CONDITION")]
    [System.Serializable]
    public partial class TEditCondition : Entity {

        // ===============================================================================
        //                                                                       Attribute
        //                                                                       =========
        #region Attribute
        /// <summary>EDIT_CONDITION_ID: {PK, NotNull, NUMBER(27)}</summary>
        protected decimal? _editConditionId;
        ...
        /// <summary>OPERATION_VALUE: {NotNull, VARCHAR2(1000)}</summary>
        ...
        //                                                                      Table Name
        //                                                                      ==========
        public String TableDbName { get { return "T_EDIT_CONDITION"; } }
        public String TablePropertyName { get { return "TEditCondition"; } }
        ...
        public virtual bool HasPrimaryKeyValue {
            get {
                if (_editConditionId == null) { return false; }
                return true;
            }
        }
        ...
        public override bool Equals(Object other) {
            if (other == null || !(other is TEditCondition)) { return false; }
            TEditCondition otherEntity = (TEditCondition)other;
            if (!xSV(this.EditConditionId, otherEntity.EditConditionId)) { return false; }
            return true;
        }
        ...
        public override int GetHashCode() {
            int result = 17;
            result = xCH(result, _editConditionId);
            return result;
        }
        ...
        public override String ToString() {
            return "TEditCondition:" + BuildColumnString() + BuildRelationString();
        }
        ...
        protected virtual String BuildColumnString() {
            String c = ", ";
            StringBuilder sb = new StringBuilder();
            sb.Append(c).Append(this.EditConditionId);
        ...
        #region Accessor
        /// <summary>EDIT_CONDITION_ID: {PK, NotNull, NUMBER(27)}</summary>
        [Seasar.Dao.Attrs.Column("EDIT_CONDITION_ID")]
        public decimal? EditConditionId {
            get { return _editConditionId; }
            set {
                __modifiedProperties.AddPropertyName("EditConditionId");
                _editConditionId = value;
            }
        }
