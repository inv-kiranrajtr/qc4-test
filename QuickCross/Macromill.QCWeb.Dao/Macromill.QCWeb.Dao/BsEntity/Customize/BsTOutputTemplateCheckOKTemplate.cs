...
namespace Macromill.QCWeb.Dao.ExEntity.Customize {
    ...
    /// <summary>
    /// The entity of TOutputTemplateCheckOKTemplate. (partial class for auto-generation)
    /// <![CDATA[
    /// [primary-key]
    ///     
    /// 
    /// [column]
    ///     OUTPUT_TEMPLATE_ID, QCWEBID, OUTPUT_TEMPLATE_MASTER_ID, UPLOAD_PATH, ALIAS
    /// 
    /// [sequence]
    ///     
    /// 
    ...
    /// </summary>
    [Seasar.Dao.Attrs.Table("TOutputTemplateCheckOKTemplate")]
    [System.Serializable]
    public partial class TOutputTemplateCheckOKTemplate : Entity {
        ...
        //                                                                      Table Name
        //                                                                      ==========
        public String TableDbName { get { return "TOutputTemplateCheckOKTemplate"; } }
        public String TablePropertyName { get { return "TOutputTemplateCheckOKTemplate"; } }

        // ===============================================================================
        //                                                                          DBMeta
        //                                                                          ======
        public DBMeta DBMeta { get { return TOutputTemplateCheckOKTemplateDbm.GetInstance(); } }
        ...
        public override bool Equals(Object other) {
            if (other == null || !(other is TOutputTemplateCheckOKTemplate)) { return false; }
            TOutputTemplateCheckOKTemplate otherEntity = (TOutputTemplateCheckOKTemplate)other;
            ...
            if (!xSV(this.Alias, otherEntity.Alias)) { return false; }
            return true;
        }
        ...
        public override String ToString() {
            return "TOutputTemplateCheckOKTemplate:" + BuildColumnString() + BuildRelationString();
        }
