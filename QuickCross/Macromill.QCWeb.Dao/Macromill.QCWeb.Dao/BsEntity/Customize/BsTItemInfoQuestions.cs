...
namespace Macromill.QCWeb.Dao.ExEntity.Customize {
    ...
    /// <summary>
    /// The entity of TItemInfoQuestions. (partial class for auto-generation)
    /// <![CDATA[
    /// [primary-key]
    ///     
    /// 
    /// [column]
    ///     ITEM_INFO_ID, QCWEBID, ITEM_NAME, SOURCE_DIV, ITEMNO, ITEM_TYPE, ANSWER_TYPE, MATRIX_DIV, LV1TITLE, LV2TITLE, ORIGINAL_LV1TITLE, ORIGINAL_LV2TITLE, TABLE_NAME, COLUMN_NAME, STATUS, SORT_FLAG, SORT_RANGE, LAST_UPDATE_DATETIME, PARENT_ITEMINFO_ID, ADD_FA_CATEGORY_INFO_ID, BASE_TABLE_NAME
    /// 
    /// [sequence]
    ///     
    /// 
    ...
    /// </summary>
    [Seasar.Dao.Attrs.Table("TItemInfoQuestions")]
    [System.Serializable]
    public partial class TItemInfoQuestions : Entity {
        ...
        //                                                                      Table Name
        //                                                                      ==========
        public String TableDbName { get { return "TItemInfoQuestions"; } }
        public String TablePropertyName { get { return "TItemInfoQuestions"; } }

        // ===============================================================================
        //                                                                          DBMeta
        //                                                                          ======
        public DBMeta DBMeta { get { return TItemInfoQuestionsDbm.GetInstance(); } }
        ...
        public override bool Equals(Object other) {
            if (other == null || !(other is TItemInfoQuestions)) { return false; }
            TItemInfoQuestions otherEntity = (TItemInfoQuestions)other;
        ...
        public override String ToString() {
            return "TItemInfoQuestions:" + BuildColumnString() + BuildRelationString();
        }
