...
namespace Macromill.QCWeb.Dao.ExEntity {
    ...
    /// <summary>
    /// The entity of T_DEFAULT_ENV_BASE as TABLE. (partial class for auto-generation)
    /// <![CDATA[
    /// [primary-key]
    ///     LANGUAGE
    /// 
    /// [column]
    ///     LANGUAGE, NOANSWER_DENOMINATOR_FLAG, VISIBLE_UNFIT_FLAG, NOANSWER_UNFIT_FLAG, WEIGHTBACK_FLAG, CELL_JOINCELL_JOIN_FLAG, CHART_DIRECTION_GT_FLAG, CHART_DIRECTION_CROSS_FLAG, NOANSWER_TARGET_FLAG, NOANSWER_AXIS_FLAG, UNFIT_TARGET_FLAG, UNFIT_AXIS_FLAG, TOTALNUM_FLAG, RATE_DIFF_COLOR_MINUS5, RATE_DIFF_COLOR_MINUS10, RATE_DIFF_COLOR_PLUS5, RATE_DIFF_COLOR_PLUS10, GRAPH_TYPE_SA, GRAPH_TYPE_SA_MATRIX, GRAPH_TYPE_MA_SIMPLE, GRAPH_TYPE_MA_CROSS, GRAPH_TYPE_MA_MATRIX, GRAPH_TYPE_N_RATE, GRAPH_TYPE_N_RANKING, SET_EXECUTE_FLAG, TITLE_ALL, TITLE_AXIS_ALL, TITLE_NOANSWER, TITLE_UNFIT, TITLE_BEFORE_WB, FLAG_STATISTICS_PARAMETER, TITLE_STATISTICS_PARAMETER, FLAG_TOTAL, TITLE_TOTAL, DP_SUM, FLAG_AVR, TITLE_AVR, DP_AVR, FLAG_SD, TITLE_SD, DP_SD, FLAG_MIN, TITLE_MIN, DP_MIN, FLAG_MAX, TITLE_MAX, DP_MAX, FLAG_MEDIAN, TITLE_MEDIAN, DP_MEDIAN, DP_WEIGHT, DP_WEIGHT_AVR, TEST_GT_FLAG, TEST_CROSS_FLAG, TEST_TYPE_GT, TEST_TYPE_CROSS, TEST_SIGNIFICANCE_LV_GT, TEST_SIGNIFICANCE_LV_CROSS
    /// 
    /// [sequence]
    ///     
    /// 
    ...
    /// 
    /// [referrer-property]
    ///     tDefaultEnvColorInfoCList
    /// ]]>
    /// Author: DBFlute(AutoGenerator)
    /// </summary>
    [Seasar.Dao.Attrs.Table("T_DEFAULT_ENV_BASE")]
    [System.Serializable]
    public partial class TDefaultEnvBase : Entity {

        // ===============================================================================
        //                                                                       Attribute
        //                                                                       =========
        #region Attribute
        /// <summary>LANGUAGE: {PK, NotNull, VARCHAR2(5)}</summary>
        ...
        /// <summary>GRAPH_TYPE_SA: {NotNull, CHAR(3)}</summary>
        protected String _graphTypeSa;

        /// <summary>GRAPH_TYPE_SA_MATRIX: {NotNull, CHAR(3)}</summary>
        protected String _graphTypeSaMatrix;

        /// <summary>GRAPH_TYPE_MA_SIMPLE: {NotNull, CHAR(3)}</summary>
        protected String _graphTypeMaSimple;

        /// <summary>GRAPH_TYPE_MA_CROSS: {NotNull, CHAR(3)}</summary>
        protected String _graphTypeMaCross;

        /// <summary>GRAPH_TYPE_MA_MATRIX: {NotNull, CHAR(3)}</summary>
        protected String _graphTypeMaMatrix;

        /// <summary>GRAPH_TYPE_N_RATE: {NotNull, CHAR(3)}</summary>
        protected String _graphTypeNRate;

        /// <summary>GRAPH_TYPE_N_RANKING: {NotNull, CHAR(3)}</summary>
        ...
        //                                                                      Table Name
        //                                                                      ==========
        public String TableDbName { get { return "T_DEFAULT_ENV_BASE"; } }
        public String TablePropertyName { get { return "TDefaultEnvBase"; } }
        ...
        protected IList<TDefaultEnvColorInfoC> _tDefaultEnvColorInfoCList;

        /// <summary>T_DEFAULT_ENV_COLOR_INFO_C as 'TDefaultEnvColorInfoCList'.</summary>
        public IList<TDefaultEnvColorInfoC> TDefaultEnvColorInfoCList {
            get { if (_tDefaultEnvColorInfoCList == null) { _tDefaultEnvColorInfoCList = new List<TDefaultEnvColorInfoC>(); } return _tDefaultEnvColorInfoCList; }
            set { _tDefaultEnvColorInfoCList = value; }
        }
        ...
        public virtual bool HasPrimaryKeyValue {
            get {
                if (_language == null) { return false; }
                return true;
            }
        }
        ...
        public override bool Equals(Object other) {
            if (other == null || !(other is TDefaultEnvBase)) { return false; }
            TDefaultEnvBase otherEntity = (TDefaultEnvBase)other;
        ...
        public override String ToString() {
            return "TDefaultEnvBase:" + BuildColumnString() + BuildRelationString();
        }
        ...
        public virtual String ToStringWithRelation() {
            ...
            sb.Append(ToString());
            String l = "\n  ";
            if (_tDefaultEnvColorInfoCList != null) { foreach (Entity e in _tDefaultEnvColorInfoCList)
            { if (e != null) { sb.Append(l).Append(xbRDS(e, "TDefaultEnvColorInfoCList")); } } }
            return sb.ToString();
        }
        ...
        protected virtual String BuildRelationString() {
            StringBuilder sb = new StringBuilder();
            String c = ",";
            if (_tDefaultEnvColorInfoCList != null && _tDefaultEnvColorInfoCList.Count > 0)
            { sb.Append(c).Append("TDefaultEnvColorInfoCList"); }
