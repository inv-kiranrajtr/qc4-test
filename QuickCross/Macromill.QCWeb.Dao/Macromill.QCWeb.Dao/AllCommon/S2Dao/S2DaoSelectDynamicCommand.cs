...
using Macromill.QCWeb.Dao.AllCommon.S2Dao.Internal.SqlParser;
using Macromill.QCWeb.Dao.AllCommon.Util;

namespace Macromill.QCWeb.Dao.AllCommon.S2Dao {
    ...
    public class S2DaoSelectDynamicCommand : SelectDynamicCommand {
        ...
        protected virtual object[] FilterArgumentsForDataReaderHandler(object[] args) {
            ...
            object[] filteredArgs;
            if (args[args.Length - 1] is Macromill.QCWeb.Dao.AllCommon.Ado.CursorHandler) {
        ...
        protected IDataReaderHandler FindSpecifiedDataReaderHandler(object[] args) {
            ...
            if (args[args.Length-1] is Macromill.QCWeb.Dao.AllCommon.Ado.CursorHandler) {
                Macromill.QCWeb.Dao.AllCommon.Ado.CursorHandler cursorHandler = (Macromill.QCWeb.Dao.AllCommon.Ado.CursorHandler)args[args.Length-1];
        ...
        protected class DataReaderCursol : IDataReaderHandler {
            protected Macromill.QCWeb.Dao.AllCommon.Ado.CursorHandler _cursorHandler;
            public DataReaderCursol(Macromill.QCWeb.Dao.AllCommon.Ado.CursorHandler cursorHandler) {
