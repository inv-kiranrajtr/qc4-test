...
using Macromill.QCWeb.Dao.AllCommon.Annotation;
...
using Macromill.QCWeb.Dao.AllCommon.S2Dao.Internal.SqlCommand;
using Macromill.QCWeb.Dao.AllCommon.S2Dao.Internal.RsHandler;
...
namespace Macromill.QCWeb.Dao.AllCommon.S2Dao {
    ...
    public class BeanMetaDataDBFluteDBMetaExtension : BeanMetaDataImpl {
        protected Macromill.QCWeb.Dao.AllCommon.JavaLike.List<IPropertyType> _primaryKeyList = new Macromill.QCWeb.Dao.AllCommon.JavaLike.ArrayList<IPropertyType>();
