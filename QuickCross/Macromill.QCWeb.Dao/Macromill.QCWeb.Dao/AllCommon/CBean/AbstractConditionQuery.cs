...
using Macromill.QCWeb.Dao.AllCommon.CBean.CHelper;
...
public abstract class AbstractConditionQuery : ConditionQuery {
    ...
    protected bool _whereSetterFlag = false;    // 2013/02/21 cterash
    ...
    public bool WhereSetterFlag {
        get { return _whereSetterFlag; }
        set { _whereSetterFlag = value; }
    }
