...
using Macromill.QCWeb.Dao.AllCommon.CBean.OutsideSql.Executor;
...
namespace Macromill.QCWeb.Dao.AllCommon.Bhv {
    ...
    public abstract class AbstractBehaviorReadable : BehaviorReadable {
        ...
        protected virtual void AssertConditionBeanNotNull(Macromill.QCWeb.Dao.AllCommon.CBean.ConditionBean cb) {
