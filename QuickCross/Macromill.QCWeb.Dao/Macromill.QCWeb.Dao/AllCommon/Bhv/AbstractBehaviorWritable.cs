...
namespace Macromill.QCWeb.Dao.AllCommon.Bhv {
    ...
    public abstract class AbstractBehaviorWritable : AbstractBehaviorReadable, BehaviorWritable {
        ...
        protected virtual void SetupCommonColumnOfInsertIfNeeds(Entity targetEntity) {
            ...
            String lastUpdateUser = Macromill.QCWeb.Dao.AllCommon.AccessContext.GetAccessUserOnThread();
            entity.LastUpdateUser = lastUpdateUser;
            
            DateTime? lastUpdateDatetime = Macromill.QCWeb.Dao.AllCommon.AccessContext.GetAccessTimestampOnThread();
            entity.LastUpdateDatetime = lastUpdateDatetime;
        ...
        protected virtual void FilterEntityOfUpdate(Macromill.QCWeb.Dao.AllCommon.Entity targetEntity) {
        }

        protected virtual void AssertEntityOfUpdate(Macromill.QCWeb.Dao.AllCommon.Entity entity) {
        }
