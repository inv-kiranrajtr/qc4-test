...
public class DBFluteConfig {
    ...
    protected String _outsideSqlPackage = "Macromill.QCWeb.Dao";
    protected IDbParameterParser _dbParameterParser;
    protected String _omitDirectoryPackage = "Aaa";
    protected String _defaultPackage = "Macromill.QCWeb.Dao";
    protected String _omitResourcePathPackage;
    protected String _flatDirectoryPackage = "Macromill.QCWeb.Dao";
