...
namespace Macromill.QCWeb.Dao.ExDao.PmBean {
    ...
    /// <summary>
    /// The parametaer-bean of PacDataprocessRenumberIteminfoPmb.
    /// Author: DBFlute(AutoGenerator)
    /// </summary>
    [System.Serializable]
    public partial class PacDataprocessRenumberIteminfoPmb : ProcedurePmb {
        ...
        public virtual String ProcedureName { get {
            return "PAC_DATAPROCESS.RENUMBER_ITEMINFO";
        }}
        ...
        public override String ToString() {
            ...
            sb.Append("PacDataprocessRenumberIteminfoPmb:");
