...
namespace Macromill.QCWeb.Dao.ExDao.PmBean {
    ...
    /// <summary>
    /// The parametaer-bean of TRawDataCreateLinePmb.
    /// Author: DBFlute(AutoGenerator)
    /// </summary>
    [System.Serializable]
    public partial class TRawDataCreateLinePmb {
        ...
        protected String _sampleIdField;
        ...
        public override String ToString() {
            ...
            sb.Append("TRawDataCreateLinePmb:");
        ...
        private String xbuildColumnString() {
            ...
            sb.Append(c).Append(_sampleIdField);
            sb.Append(c).Append(_dataField);
        ...
        public String SampleIdField {
            get { return (String)ConvertEmptyToNullIfString(_sampleIdField); }
            set { _sampleIdField = value; }
        }

        public String DataField {
            get { return (String)ConvertEmptyToNullIfString(_dataField); }
