...
namespace Macromill.QCWeb.Dao.ExDao.PmBean {
    ...
    /// <summary>
    /// The parametaer-bean of TDataEditListSelectPmb.
    /// Author: DBFlute(AutoGenerator)
    /// </summary>
    [System.Serializable]
    public partial class TDataEditListSelectPmb {
        ...
        public override String ToString() {
            ...
            sb.Append("TDataEditListSelectPmb:");
        ...
        private String xbuildColumnString() {
            ...
            sb.Append(c).Append(_latestFlag);
            sb.Append(c).Append(_executeFlag);
