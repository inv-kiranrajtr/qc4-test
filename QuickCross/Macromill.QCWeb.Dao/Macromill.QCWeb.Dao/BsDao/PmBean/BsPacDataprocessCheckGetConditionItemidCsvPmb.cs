...
namespace Macromill.QCWeb.Dao.ExDao.PmBean {
    ...
    /// <summary>
    /// The parametaer-bean of PacDataprocessCheckGetConditionItemidCsvPmb.
    /// Author: DBFlute(AutoGenerator)
    /// </summary>
    [System.Serializable]
    public partial class PacDataprocessCheckGetConditionItemidCsvPmb : ProcedurePmb {
        ...
        public virtual String ProcedureName { get {
            return "PAC_DATAPROCESS_CHECK.GET_CONDITION_ITEMID_CSV";
        }}
        ...
        public override String ToString() {
            ...
            sb.Append("PacDataprocessCheckGetConditionItemidCsvPmb:");
