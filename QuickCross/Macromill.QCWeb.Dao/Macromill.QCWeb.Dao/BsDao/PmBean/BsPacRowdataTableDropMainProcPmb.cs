...
namespace Macromill.QCWeb.Dao.ExDao.PmBean {
    ...
    /// <summary>
    /// The parametaer-bean of PacRowdataTableDropMainProcPmb.
    /// Author: DBFlute(AutoGenerator)
    /// </summary>
    [System.Serializable]
    public partial class PacRowdataTableDropMainProcPmb : ProcedurePmb {
        ...
        public virtual String ProcedureName { get {
            return "PAC_ROWDATA_TABLE_DROP.MAIN_PROC";
        }}
        ...
        public override String ToString() {
            ...
            sb.Append("PacRowdataTableDropMainProcPmb:");
